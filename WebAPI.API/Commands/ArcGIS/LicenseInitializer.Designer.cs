...
namespace WebAPI.API.Commands.ArcGIS
{
    internal partial class LicenseInitializer
    {
        ...
        public bool InitializeApplication(esriLicenseProductCode[] productCodes,
            esriLicenseExtensionCode[] extensionLics)
        {
        ...
        public string LicenseMessage()
        {
            ...
            {
                var info = ReportInformation(m_AoInit as ILicenseInformation, item.Key, item.Value);
        ...
        private bool Initialize()
        {
            ...
            foreach (var prodNumber in m_requestedProducts)
            {
                esriLicenseProductCode prod =
                    (esriLicenseProductCode)Enum.ToObject(typeof(esriLicenseProductCode), prodNumber);
        ...
        private Dictionary<esriLicenseProductCode, esriLicenseStatus> m_productStatus =
            new Dictionary<esriLicenseProductCode, esriLicenseStatus>();

        private Dictionary<esriLicenseExtensionCode, esriLicenseStatus> m_extensionStatus =
            new Dictionary<esriLicenseExtensionCode, esriLicenseStatus>();
