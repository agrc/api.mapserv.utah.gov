...
namespace WebAPI.Dashboard
{
    public class AutoMapperConfig
    {
        public static void RegisterMaps()
        {
            ...
            {
                cfg.CreateMap<StatsPerApiKey.Stats, ApiKeyViewModel>()
                    .ForMember(x => x.ApiKey, y => y.MapFrom(z => z.Key))
                    .ForMember(x => x.LastUsed, y => y.ResolveUsing<CalculateTimeAgoResolver, long>(src => src.LastUsed))
                ...
                cfg.CreateMap<UsageViewModel, ApiKeyViewModel>()
                    .ForMember(x => x.ApiKey, y => y.MapFrom(z => z.Key.Key))
                    .ForMember(x => x.LastUsed, y => y.ResolveUsing<CalculateTimeAgoResolver, long>(src => src.LastUsedTicks))
