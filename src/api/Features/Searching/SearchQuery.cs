        ...
        public async Task<IApiResponse> Handle(Query request, CancellationToken cancellationToken) {
            ...
            try {
                ...
                return new ApiResponseContract<IReadOnlyCollection<SearchResponseContract?>> {
                    ...
                    Message = $"The table `{tableName}` does not exist in the SGID. Connect to the Open SGID (https://gis.utah.gov/documentation/sgid/open-sgid/) to verify the table exists. Please read https://gis.utah.gov/blog/2019-11-12-sgid-product-relaunch-update/#static-sgid-data-layers for more information."
                };
