...
A Utah municipality name or a 5 digit zip code. The word, "City", is optional. For example, both "Sandy" and "Sandy City" will return the same result. The spelling should match (case-insensitive) the values in the "Zone" column of this [spreadsheet](https://docs.google.com/spreadsheets/d/1Dc77HLVn9YXgY1JkcqqaMh1Tm0cemwXxFfyHb7dP0Cs/edit#gid=0). Have a suggestion for a new value to add to the list? [Let us know](https://github.com/agrc/api.mapserv.utah.gov/issues/new).
