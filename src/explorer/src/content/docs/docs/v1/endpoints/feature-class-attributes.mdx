...
<Uri verb="GET" endpoint="info/fieldnames" properties={['tableName']} />
...
The name of an OpenSGID table. Use the [table name](/docs/v1/endpoints/feature-class-names) endpoint to find a table name or read the [getting connected guide](https://gis.utah.gov/documentation/sgid/open-sgid/) to browse the OpenSGID for a table name.
