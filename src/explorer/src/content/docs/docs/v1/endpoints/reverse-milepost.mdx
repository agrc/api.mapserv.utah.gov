...
Reverse geocoding this process of converting a geographic location (i.e., the geographical coordinates) to a human-readable address. This UGRC API endpoint allows you to get the nearest route and milepost from a geographic location.
