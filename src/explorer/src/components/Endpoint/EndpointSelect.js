...
export default function Field(props) {
  ...
  return (
    <div className="flex flex-wrap pt-3 md:justify-around md:flex-no-wrap">
      ...
      <select className="bg-white focus:outline-none focus:border-indigo-200 border border-gray-300 rounded md:rounded-none md:rounded-l-lg mx-2 md:mx-0 py-2 px-4 block w-full appearance-none leading-normal">
        {props.children}
      </select>
