  ...
  return (
    <section className="max-w-4xl">
      ...
      <Description>
        ...
        a result. If the house number exists in the range of the street, a coordinate will be extrapolated.
      </Description>
      <Label>zone</Label>
      <Description>
      ...
      <Description>
        ...
        reference and the{' '}
        <Link url="https://desktop.arcgis.com/en/arcmap/10.5/map/projections/pdf/projected_coordinate_systems.pdf">Projected Coordinate System</Link> reference.
        UTM Zone 12 N, with the WKID of <strong className="text-indigo-900">26912</strong>, is the default. This coordinate system is the most accurate
        reflection of Utah. It is recommended to use this coordinate system if length and area calculations are important as other coordinate systems will skew
        the truth.
            ...
            <tbody className="bg-white">
              <tr>
                ...
                <td className="border-b border-gray-200 p-2 text-gray-800">
                  This is the State standard for all Utah spatial data. It has the least distortion for the state of Utah and the most accurate length and area
                  calculations.
                </td>
              </tr>
              <tr>
      ...
      <Description>
        Every street zone geocode will return a score for the match on a scale from 0-100. The score is a rating of how confident the system is in the choice of
        coordinates based on the input. For example, misspellings in a street name, omitting a street type when multiple streets with the same name exist, or
        omitting a street direction when the street exists in multiple quadrants will cause the result to lose points. Depending on your needs, you may need to
        limit the score the system will return. The default value of <strong className="text-indigo-900">70</strong> will give acceptable results. If you need
        extra control, use the suggest and scoreDifference options
      </Description>
      <Label>format</Label>
      <Description>
      ...
      <Description>
        ...
        <Code>true</Code>, will return a location for a P.O. Box only when the input zone is a 5 digit zip code. The result will be where the mail is delivered.
        This could be a traditional post office, community post office, university, etc. When analyzing where people live, P.O. Box information will skew
        results since there is no correlation between where mail is delivered and where the owner of the mail liver. View the{' '}
      ...
      <Description>
        ...
        <Link url="https://opendata.gis.utah.gov/datasets/utah-roads">road center line</Link> data and provide the best match rate. Address point locations are
        used in the event of a tie. Address points are a work in progress with the counties to map structures or places where mail is delivered. Road
